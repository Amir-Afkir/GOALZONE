defmodule SocialAppWeb.ProfileLive.Show do
  ...
  def render(assigns) do
    ~H"""
    <section :if={@not_found} class="panel">
    ...
    <section :if={!@not_found} class="stack-lg">
      <section class="panel matchday-hero">
      ...
      <section :if={@show_dashboard} class="panel stack-md">
      ...
      <section class="panel stack-md">
        ...
        <article :for={post <- @posts} class="panel panel-inner">
